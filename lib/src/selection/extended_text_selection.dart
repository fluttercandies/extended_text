...
class ExtendedTextSelectionState extends State<ExtendedTextSelection>
  ...
  ExtendedRenderParagraph? get _renderParagraph =>
      _renderParagraphKey.currentContext!.findRenderObject() as ExtendedRenderParagraph?;
  ...
  void didUpdateWidget(ExtendedTextSelection oldWidget) {
    ...
    if (widget.textSelectionGestureDetectorBuilder != oldWidget.textSelectionGestureDetectorBuilder)
      _initGestureDetectorBuilder();
  }
        ...
        child: CompositedTransformTarget(
            ...
            child: Semantics(
              ...
              child: ExtendedRichText(
                ...
                textDirection:
                    widget.textDirection, // RichText uses Directionality.of to obtain a default if this is null.
